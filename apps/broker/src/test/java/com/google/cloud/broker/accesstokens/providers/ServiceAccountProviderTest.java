...
public class ServiceAccountProviderTest {
    ...
    private static final String PROJECT = System.getenv().get("APP_SETTING_GCP_PROJECT");
    ...
    public void testSuccess() {
        ...
        AccessToken accessToken = provider.getAccessToken("alice-svc-acct@" + PROJECT + ".iam.gserviceaccount.com", SCOPE);
    ...
    public void testUnauthorized() {
        ServiceAccountProvider provider = new ServiceAccountProvider();
        try {
            provider.getAccessToken("bob-svc-acct@" + PROJECT + ".iam.gserviceaccount.com", SCOPE);
