...
public class Validation {
    ...
    public static void validateImpersonator(String impersonator, String impersonated) {
        if (impersonator.equals(impersonated)) {
            ...
            String proxyString = AppSettings.getProperty(AppSettings.PROXY_USER_WHITELIST, "");
    ...
    public static void validateScope(String scope) {
        String whitelist = AppSettings.getProperty(AppSettings.SCOPE_WHITELIST, "https://www.googleapis.com/auth/devstorage.read_write");
