...
public class TestingTools {
          ...
          InProcessServerBuilder.forName(serverName)
              ...
              .addService(
                  ServerInterceptors.intercept(
                      fakeServer, new AuthorizationHeaderServerInterceptor()))
              .build()
              .start());
    } catch (IOException e) {
  ...
  /**
   * Test implementation of the broker server, including SPNEGO authentication for incoming
   * requests.
   */
  static class FakeBrokerImpl extends BrokerGrpc.BrokerImplBase {
    ...
    String authenticateUser() {
      String authorizationHeader =
          AuthorizationHeaderServerInterceptor.AUTHORIZATION_CONTEXT_KEY.get();
