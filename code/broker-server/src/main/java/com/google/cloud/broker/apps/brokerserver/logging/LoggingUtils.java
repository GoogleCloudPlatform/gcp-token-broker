...
public class LoggingUtils {
    ...
    public static final String MDC_AUTH_MODE_DELEGATED_SESSION_ID_KEY = MDC_KEY_PREFIX + "delegatedSessionId";
    public static final String MDC_AUTH_MODE_PROXY_IMPERSONATED_USER_KEY = MDC_KEY_PREFIX + "impersonatedUser";
